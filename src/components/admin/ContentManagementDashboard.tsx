...
const ContentManagementDashboard = () => {
  const { content, loading, stats } = useContentManagement();
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-success">{stats?.published || 0}</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-secondary">{stats?.drafts || 0}</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-primary">{stats?.pages || 0}</div>
          </CardContent>
        </Card>
      </div>
